...
$P(X=5)=P(X=15)=0,25$ e $P(X=10) = 0,50$. $P(Y=8)=P(Y=12)=0,25$ e $P(Y=2)=0,5$.
...
$E[Y]=\sum_{y\in\Upsilon}yp(y)=2*0.5+8*0.25+12*0.25=$ `r 2*0.5+8*0.25+12*0.25`

--

$Var[X]=\sum_{x\in\chi}(x-\bar{x})^2 p(x)=$ `r (5^2*0.25 + 10^2*0.5 + 15^2*0.25)-(5*0.25 + 10*0.5 + 15*0.25)^2`

$Var[Y]=\sum_{y\in\Upsilon}(y-\bar{y})^2 p(y)=$ `r (2^2*0.5+8^2*0.25+12^2*0.25)-(2*0.5+8*0.25+12*0.25)^2`
